...
>> vim since i have used this extensively
...
>> Sublime text; I have prior experience using this editor and really like its look and feel, as well as the fact that it shows what the structure of the code looks like on the rhs with tiny text.
